            ...
            <div class="bottom">
              <div class="container-fluid">
                <div class="row">
                  <div class="col-10">
                    <span class="item-services">
                      <?php $url_offer_details = get_bloginfo('wpurl').'/'.$_SESSION['pivot'][$page->id]['path'].'/'.$offre->attributes()->codeCgt->__toString().'&type='.$offre->typeOffre->attributes()->idTypeOffre->__toString(); ?>
