  ...
  <aside class="col-xs-12 col-md-3">
    ...
    <section class="pivot-contacts card lis-brd-light wow fadeInUp mb-4">
      <div class="card-body p-4">
        ...
        <ul class="adr list-unstyled lis-line-height-2 mb-0">
          ...
          <span class="locality"><?php print (isset($offre->adresse1->commune)?$offre->adresse1->commune->value->__toString():''); ?></span>
    ...
    <section class="pivot-share card lis-brd-light wow fadeInUp mb-4">
      ...
      <div class="add-to-calendar card-body p-4">
        <span class="fa fa-align-right pr-2 fa-google"><a href="https://calendar.google.com/calendar/r/eventedit?text=<?php echo $offre->nom->__toString(); ?>&dates=<?php echo date("Ymd", strtotime($dateStart)); ?>/<?php echo date("Ymd", strtotime($dateEnd)); ?>">Google</a></span>
